...
enum class diag_code : uint8_t {
    ...
    invalid_operands_for_binary_expression,
    ...
    cannot_infer_type_of_expression_at_compt,
    ...
    cannot_assign_compt_value_to_mutable_ref_type,
    cannot_assign_compt_value_to_mutable_slice_type,
    ...
    code_is_unreachable_following_a_block_terminating_statement,
    block_terminating_statement_here,
