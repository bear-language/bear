...
br_test_result_t test_hir(void) {
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args20, 23);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args58, 35);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args63, 26);
    char* args64[] = {"bearc", "tests/hir/64.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args64, 24);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args_a02, 11);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args_a07, 10);
