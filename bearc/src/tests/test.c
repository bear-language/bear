...
br_test_result_t test_parser(void) {
    ...
    ASSERT_EQ_ERR("parser/60", 0);
    ASSERT_EQ_ERR("parser/61", 0);
    ASSERT_EQ_ERR("parser/62", 0);
    ASSERT_EQ_ERR("parser/63", 2);
    ASSERT_EQ_ERR("parser/64", 2);
    ASSERT_EQ_ERR("parser/65", 0);
    ASSERT_EQ_ERR("parser/66", 2);
    ASSERT_EQ_ERR("parser/67", 0);
...
br_test_result_t test_hir(void) {
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args20, 20);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args25, 10);
    char* args26[] = {"bearc", "00.br", "-I", "tests/projects/03"};
    ASSERT_EQ_ERR_FROM_ARGSN(args26, 10, 3);
    char* args27[] = {"bearc", "tests/hir/26.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args27, 5);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args32, 11);
    char* args33[] = {"bearc", "tests/hir/33.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args33, 8);
    char* args34[] = {"bearc", "tests/hir/34.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args34, 3);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args49, 5);
    char* args50[] = {"bearc", "tests/hir/50.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args50, 6);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args53, 30);
    char* args54[] = {"bearc", "tests/hir/54.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args54, 10);
    char* args55[] = {"bearc", "tests/hir/55.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args55, 15);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args58, 41);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args77, 18);
    char* args78[] = {"bearc", "tests/hir/78.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args78, 15);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args88, 7);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args99, 13);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args_a03, 9);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args_a15, 21);
    ...
    char* args_a18[] = {"bearc", "tests/hir/a18.br", "-s"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a18, 36);
    char* args_a19[] = {"bearc", "tests/hir/a19.br", "-s", "-I", "tests/lib"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a19, 1);
    char* args_a20[] = {"bearc", "tests/hir/a20.br", "-s"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a20, 14);
    char* args_a21[] = {"bearc", "tests/hir/a21.br", "-s", "-I", "tests/lib"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a21, 10);
    char* args_a22[] = {"bearc", "tests/hir/a22.br", "-s"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a22, 5);
    char* args_a23[] = {"bearc", "tests/hir/a23.br", "-s"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a23, 4);
    char* args_a24[] = {"bearc", "tests/hir/a24.br", "-s"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a24, 19);
    char* args_a25[] = {"bearc", "tests/hir/a25.br", "-s"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a25, 3);
    char* args_a26[] = {"bearc", "tests/hir/a26.br", "-s"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a26, 3);
    char* args_a27[] = {"bearc", "tests/hir/a27.br", "-s"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a27, 16);
    char* args_a28[] = {"bearc", "tests/hir/a28.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a28, 12);
    char* args_a29[] = {"bearc", "tests/hir/a29.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a29, 2);
    char* args_a30[] = {"bearc", "tests/hir/a30.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a30, 2);
    char* args_a31[] = {"bearc", "tests/hir/a31.br"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a31, 1);
    char* args_a32[] = {"bearc", "tests/hir/a32.br", "-I", "tests/lib"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a32, 13);
    ASSERT_EQ_ERR("hir/a33", 2);
    ASSERT_EQ_ERR("hir/a34", 39);
    ASSERT_EQ_ERR("hir/a35", 28);
    ...
    ASSERT_EQ_ERR("hir/a43", 6);
    ASSERT_EQ_ERR("hir/a44", 1);
    ASSERT_EQ_ERR("hir/a45", 2);
    ASSERT_EQ_ERR("hir/a46", 2);
    ASSERT_EQ_ERR("hir/a47", 5);
    ASSERT_EQ_ERR("hir/a48", 2);
    ASSERT_EQ_ERR("hir/a49", 0);
    ASSERT_EQ_ERR("hir/a50", 1);
    ASSERT_EQ_ERR("hir/a51", 0);
    ASSERT_EQ_ERR("hir/a52", 0);
    ASSERT_EQ_ERR("hir/a53", 1);
    ASSERT_EQ_ERR("hir/a54", 3);
    ASSERT_EQ_ERR("hir/a55", 3);
    ASSERT_EQ_ERR("hir/a56", 3);
    char* args_a57[] = {"bearc", "tests/hir/a57.br", "-I", "tests/lib"};
    ASSERT_EQ_ERR_FROM_ARGS(args_a57, 1);
    ASSERT_EQ_ERR("hir/a58", 9);
    ...
    ASSERT_EQ_ERR("hir/a67", 3);
    ASSERT_EQ_ERR("hir/a68", 11);
    ASSERT_EQ_ERR("hir/a69", 2);
    ...
    ASSERT_EQ_ERR("hir/a78", 6);
    ASSERT_EQ_ERR("hir/a79", 1);
    ASSERT_EQ_ERR("hir/a80", 1);
    ASSERT_EQ_ERR("hir/a81", 604);
    ASSERT_EQ_ERR("hir/a82", 0);
    ASSERT_EQ_ERR("hir/a83", 7);
    char* args04[] = {"bearc", "main.br", "-I", "tests/projects/04", "tests/lib"};
    ASSERT_EQ_ERR_FROM_ARGSN(args04, 2, 3);
    ASSERT_EQ_ERR("hir/a84", 10);
    ASSERT_EQ_ERR("hir/a85", 1);
