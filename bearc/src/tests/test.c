...
br_test_result_t test_hir(void) {
    ...
    ASSERT_EQ_ERR_FROM_ARGSN(args7, 6, 3);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args13, 38);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args49, 8);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args_a02, 14);
    ...
    ASSERT_EQ_ERR_FROM_ARGS(args_a21, 9);
